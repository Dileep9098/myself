...
//     // Step 2: Toggle the state when the header toggle button is clicked
//     const headerToggle = () => {
//         setShow(!show);
//     };
//     useEffect(() => {
...
//                 {/* Step 3: Attach the toggle function to the button */}
//                 <i
...
//                     <img src="assets/img/my-profile-img.jpg" alt="" className="img-fluid " />
...
//                         <h2>Dileep Sahu</h2>
//                         <p>
//                             I'm <span className="typed" data-typed-items="Full Stack Developer,Frontend Developer,Backend Developer, Developer,">Designer</span>
...
//             <header
//                 id="header"
//                 className={`header dark-background d-flex flex-column ${show ? 'header-show' : ''}`}
//             >
//                 <i
...
//                 <nav id="navmenu" className="navmenu" ref={menuRef}>
//                     <ul>
//                         <li><a href="#hero" className="active"><i className="bi bi-house navicon"></i>Home</a></li>
//                         <li><a href="#about"><i className="bi bi-person navicon"></i> About</a></li>
//                         <li><a href="#resume"><i className="bi bi-file-earmark-text navicon"></i> Resume</a></li>

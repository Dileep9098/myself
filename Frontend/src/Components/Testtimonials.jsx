...
export default function Testimonials() {
  useEffect(() => {
    ...
    return () => {
      swiper.destroy(); // Cleanup swiper instance when component is unmounted
    };
  }, []);
              ...
              <div className="testimonial-item">
                <p>
                  ...
                  <span>
                    ...
                    cillum quid malis quorum velit fore eram velit sunt aliqua noster fugiat irure
              ...
              <div className="testimonial-item">
                <p>
                  ...
                  <span>
                    ...
                    minim fugiat dolor enim duis veniam ipsum anim magna sunt elit fore quem dolore
                    labore illum veniam.
                  </span>
                  <i className="bi bi-quote quote-icon-right"></i>
                </p>
